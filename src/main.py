...
# Railway/Render: فایل کنار main.py ذخیره می‌شه
# Wasmer Edge: از مسیر /app/data استفاده می‌کنه (persistent volume)
DB_FILE = os.environ.get("DB_FILE", "aura_gateway.db")
